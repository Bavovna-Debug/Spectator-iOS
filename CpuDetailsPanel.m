...
@implementation CpuDetailsPanel
{
    CGRect chartsFrame;
}
...
- (void)serverDidSet
{
    ...
    for (CpuDetailsBarGraph *chart in self.charts)
    {
...
- (void)refreshCharts
{
    if ([self.charts count] == 0)
    {
        ...
        {
            CpuDetailsBarGraph *chart = [[CpuDetailsBarGraph alloc] initWithFrame:CGRectInset(chartFrame, 1, 1)
