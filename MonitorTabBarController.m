...
@interface MonitorTabBarController () <ServerConnectionDelegate>

@property (weak, nonatomic) Server                       *server;
@property (strong, nonatomic) UINavigationItem           *navigationItem2;
@property (strong, nonatomic) CpuViewController          *cpuViewController;
@property (strong, nonatomic) MountsViewController       *mountsViewController;
@property (strong, nonatomic) NetworkViewController      *networkViewController;
@property (strong, nonatomic) ConnectionsViewController  *connectionsViewController;
...
- (void)viewDidLoad
{
    ...
    self.cpuViewController = [[CpuViewController alloc] initWithFrame:frame];
    self.mountsViewController = [[MountsViewController alloc] initWithFrame:frame];
    self.networkViewController = [[NetworkViewController alloc] initWithFrame:frame];
    self.connectionsViewController = [[ConnectionsViewController alloc] initWithFrame:frame];
...
- (void)setServer:(Server *)server
{
    if (server != _server) {
        ...
        for (MonitorViewController *controller in [self viewControllers])
